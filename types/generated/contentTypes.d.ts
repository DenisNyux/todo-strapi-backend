...
export interface ApiTodoTodo extends Schema.CollectionType {
  ...
  attributes: {
    todoTitle: Attribute.String & Attribute.Required;
    todoDescription: Attribute.Blocks;
    todoPriority: Attribute.Enumeration<
      ['critical', 'important', 'standart', 'unimportant']
    > &
      Attribute.Required &
      Attribute.DefaultTo<'standart'>;
    todoDone: Attribute.Boolean &
      Attribute.Required &
      Attribute.DefaultTo<false>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
